...
const projec = () => {
  return (
    <div className='container max-w-7xl mx-auto py-20'>
        ...
        transition={{ duration: 0.5 }} className='text-4xl font-bold mb-4 text-center'>My Projects</motion.h1>
        <motion.p  initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5, delay: 0.2 }} className='text-lg text-secondary mb-24 text-center'>Here are some of my recent projects. Click on the link to view the code or live demo</motion.p>
